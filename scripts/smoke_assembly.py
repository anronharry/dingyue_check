...
import app.bot_async as bot_async
...
def assemble_application() -> int:
    ...
    bot_async.register_handlers(
        app,
        {
            ...
            "ownerpanel": bot_async.owner_panel_command,
            "recentusers": bot_async.recent_users_command,
            "recentexports": bot_async.recent_exports_command,
