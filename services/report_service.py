...
我主要帮你完成 3 件事：
• 发送 <b>订阅链接</b>，我帮你检测是否可用
• 发送 <b>TXT / YAML 文件</b>，我帮你互相转换
• 自动提醒 <b>即将过期</b> 和 <b>流量告急</b> 的订阅

<b>快速使用</b>
• 直接发送订阅链接
• 直接上传 TXT / YAML 文件
• 直接粘贴节点文本，例如 `vmess://`、`ss://`
...
<b>二、最常用命令</b>
/check - 检测我的所有订阅
/check [标签] - 只检测某个标签下的订阅
/list - 查看订阅列表，并可直接重新检测 / 添加标签 / 删除
/stats - 查看我的订阅统计
...
/usageaudit - 查看最近谁用过机器人、检测了哪些订阅链接
/checkall - 检测所有用户的订阅
